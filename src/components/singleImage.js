...
function SingleImage({ image, index, updateCheck, selectItems }) {
  ...
  return (
    <div
      className={`border  rounded-md text-center mx-auto single-image relative ${
        index === 0 ? "feature_image " : ""
      }`}
    >
